...
export default function App() {
  ...
  // HomeScreen component extracted to src/screens/HomeScreen.tsx
  const HomeScreen = () => {
    const { HomeScreen: HomeScreenComponent } = require('./src/screens/HomeScreen');
  ...
  // ReviewScreen component extracted to src/screens/ReviewScreen.tsx
  const ReviewScreen = () => {
    const { ReviewScreen: ReviewScreenComponent } = require('./src/screens/ReviewScreen');
